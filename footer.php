...
?>
	    ...
	    <footer id="colophon" class="site-footer" role="contentinfo">
	       <div class="container">
	         <div class="row">
	           <div class="col-md-4">
							 <div><?php printf(esc_html__('Powered by: %1$s ', 'framemacz'), '<a href="https://webmacz.ml/" rel="designer">WebMacZ & Sons</a>'); ?></div>
            ...
            // Make sure there is a social menu to display.
            		if (has_nav_menu('menu-2')) { ?>
		                    ...
		                    wp_nav_menu(array(
		                        ...
		                        // 'link_after'     => '</span>'
		                        'link_after'     => '</span>' . framemacz_get_svg(array( 'icon' => 'chain' )),
		                    )); ?>
								</nav><!-- .social-menu -->
							<?php }		?>
						 ...
						 <div class="col-md-4">
						   ...
						   <div><?php printf(esc_html__('%1$s Theme by %2$s', 'framemacz'), 'Framemacz', '<a href="#" rel="designer">Raymacz</a>'); ?></div>
						 </div>	 <!-- col-md-4 -->
	         </div> <!-- row -->
	       </div> <!-- container -->
	     </footer>  <!-- colophon -->
