...
if ( ! function_exists( 'framemacz_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function framemacz_posted_on() {
		...
		echo '<span class="posted-on">' . $posted_on . '</span><span class="byline"> ' . $byline . '</span>'; // WPCS: XSS OK.
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'framemacz' ),
						array(
							'span' => array(
								'class' => array(),
							),
			...
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'framemacz' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'framemacz_post_thumbnail' ) ) :
/**
 ...
 */
function framemacz_post_navigation() {
	the_post_navigation( array(
		'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'framemacz' ) . '</span> ' .
			'<span class="screen-reader-text">' . __( 'Next post:', 'framemacz' ) . '</span> ' .
			'<span class="post-title">%title</span>',
		'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'framemacz' ) . '</span> ' .
			'<span class="screen-reader-text">' . __( 'Previous post:', 'framemacz' ) . '</span> ' .
			'<span class="post-title">%title</span>',
	) );
}
